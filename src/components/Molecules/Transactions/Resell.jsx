    ...
    return (
        ...
        >
            ...
            <AccordionDetails>
                ...
                <Typography>
                    Token id : {props.transaction.act.data.resell.token_id}
                </Typography>
                <Typography>
                    Sell price: {props.transaction.act.data.resell.price}
                </Typography>
                <Typography>
                    Promoter basis point:{' '}
                    {props.transaction.act.data.resell.promoter_basis_point}
                </Typography>
            </AccordionDetails>
        </Accordion>
    )
