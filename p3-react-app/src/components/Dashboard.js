...
function Dashboard() {
  ...
  function getTransactions() {
    ...
    fetch(
     `https://api.mainnet.ultra.io/v0/search/transactions?q=(auth:${wallet} OR receiver:${wallet})&sort=desc&limit=5&block_count=5000000&start_block=0&limit=5&cursor&with_reversible=true`,
      requestOptions
    )
